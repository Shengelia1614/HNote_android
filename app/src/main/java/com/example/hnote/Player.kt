...
//                    }
                    ...
                    binding.imageDisplayScreen.post{
                        ...
                        if (mainActivity.audio.SongArtBitmap != null) {
                            binding.SongImage.setImageBitmap(mainActivity.audio.SongArtBitmap)
                        } else {
...
//                    }
                    ...
                    myFrequencyJob= mainScope.launch {
                        ...
                        try {
                            ...
                            mainActivity.stopFrequencyAnalyzer()
                        }
                    }
                    myJob = mainScope.launch {
                        ...
                        try {
                            while (isActive) {
                                ...
                                while ( true) {
                                    ...
                                    if(playtime<mainActivity.audio.player.duration){
                                        if(playing==1) {
                                            ...
                                            binding.timepast.text = String.format(
                                                "%d:%02d",
                                                (playtime / 60000).toLong(),
                                                ((playtime % 60000) / 1000).toLong()
                                            )
...
//    }
    ...
    fun applyFequencyVisuals(){
        ...
        var visuals=mainActivity.getLatestFrequencyAmplitudes()
    ...
    fun applyProgressAnimations(animationController: AnimationController) {
        animationController.updateProgress(mainActivity.audio.player.duration,binding.progressTrack.width,8)
        binding.progressingTrack.pivotX=0f
        //binding.progressingTrack.scaleX=animationController.Progressingbar
        val layoutParams = binding.progressingTrack.layoutParams
